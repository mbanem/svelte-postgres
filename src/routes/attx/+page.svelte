...
<Tooltip {...props} {tooltipPanel} class_tooltipPanel={'css-prop-tooltipPanel'}>
  <button onclick={printReport}>print report</button>
</Tooltip>
<button style="margin:250rem 0 0 250rem;">print report</button>
