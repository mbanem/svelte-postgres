...
<div class="container">
  <div>
    ...
    <br />
    <button
      onclick={() => setTheme('rebeccapurple')}
      style="color:rebeccapurple;">apply rebeccapurple class</button
    >
    <br />
  ...
  <div style="display:inline-block;">
    <pre style="color:var(--BODY-COLOR);margin:0;padding:0;">
		...
		A TypeScript function(s) change the values of Theme variables based on
		some settings defined for every button that change them
		when clicked, e.g.
