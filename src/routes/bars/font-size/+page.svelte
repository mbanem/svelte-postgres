...
<div class="container">
  <div class="clamp" style={`font-size:${fontSize}`}>
    <!--cSpell:disable -->
    FONT SIZE based on clamp lorem ipsum dolor, sit amet consectetur adipisicing
    elit. Repellat natus dolorem perspiciatis aspernatur minus ab! Eligendi doloremque
    provident voluptate, voluptas debitis, veritatis, molestiae in aut odit atque
    nemo vero aspernatur!
    <!--cSpell:enable -->
  </div>
